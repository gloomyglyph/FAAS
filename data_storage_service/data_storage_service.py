...
async def serve(host: str, port: int, mongo_host: str, mongo_port: int, redis_host: str, redis_port: int):
...
if __name__ == "__main__":
    ...
    asyncio.run(serve(args.host, args.port, args.mongo_host, args.mongo_port, args.redis_host, args.redis_port))